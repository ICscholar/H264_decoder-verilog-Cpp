...
module transform_regs(
	...
	input AC_all_0_wr,
	input IQ_wr,
	input DHT_wr,//IDCT/DCT工作 Flag信号
	input IDCT_wr,

	input signed [15:0] curr_DC, //当前DC值curr_DC

	input [15:0] IQ_out_0,//IQ模块输出的16个系数IQ_out
	input [15:0] IQ_out_1,
	input [15:0] IQ_out_2,
	input [15:0] IQ_out_3,
	input [15:0] IQ_out_4,
	...
	input signed [15:0] butterfly_out_0,//DCT结果butterfly_out
